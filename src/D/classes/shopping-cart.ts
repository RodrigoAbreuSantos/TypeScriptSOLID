...
export class ShoppingCartLegacy implements ShoppingCartProtocol{ //classe que pode adicionar, remover, mostrar, calcular total e limpar items, implementa a interface, ou seja tudo que tem na interface tem que ter aqui
